    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            //creating arrays for storing delivery details
             ...
             int [] deliverySource= new int [MAX_DELIVERIES];
             int [] deliveryDestination= new int [MAX_DELIVERIES];
             int [] deliveryDistance= new int [MAX_DELIVERIES];
             int [] deliveryVehicle= new int [MAX_DELIVERIES];
             double [] deliveryWeight= new double[MAX_DELIVERIES];
             double [] deliveryCharge= new double[MAX_DELIVERIES];
